...
class BasePlayer(object):
    ...
    def run(self):
        n_games = self.games_num # TODO 2000
        render = self.render_env 
        n_game_life = self.n_game_life # TODO 1
        ...
        for _ in range(n_games): 
            ...
            for n in range(self.max_steps):# TODO 108000 // 4
                ## TODO ###################################
                ## for keyboard input #####################
                # if (self.keyQueue.qsize() > 0):
                #     key = self.keyQueue.get()
                #     if key == "w":
                #         self.command_vel_x = self.command_vel
                #         self.command_vel_y = 0
                #         self.command_vel_yaw = 0
                #     elif key == "d":
                #         self.command_vel_x = self.command_vel * 0.5
                #         self.command_vel_y = 0
                #         self.command_vel_yaw = -self.command_vel*0.5*0.25
                #     elif key == "a":
                #         self.command_vel_x = self.command_vel * 0.5
                #         self.command_vel_y = 0
                #         self.command_vel_yaw = self.command_vel*0.5*0.25
                ...
                #         self.command_vel_y = self.command_vel*0.5
                #         self.command_vel_yaw = 0
                #     elif key == "e":
                #         self.command_vel_x = 0
                #         self.command_vel_y = -self.command_vel*0.5
                ...
                #         # self.command_pz = 0.2
                #     elif key == "s":
                #         self.command_px = 0+0.3#-self.command_vel*0.1
                #         self.command_py = 0
                #         self.command_pz = 0.3
                #     else : 
                #         self.command_px = 0+0.3
                ...
                ## TODO ###################################
                ## for keyboard input ##################### 
                # obses[:, -3] = self.command_vel_x
                # obses[:, -2] = self.command_vel_y
                # obses[:, -1] = self.command_vel_yaw
                # print(obses[:,12:24])
                # obses[:, -3] = self.command_px
                # obses[:, -2] = self.command_py
                # obses[:, -1] = self.command_pz
                # print(obses[0, :9])
                ## TODO ###################################
                ## for keyboard input ##################### 
