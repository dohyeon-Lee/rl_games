...
class Runner:
    ...
    def load_config(self, params): # TODO param : AnymalPPO.yaml
        ...
        self.algo_name = self.algo_params['name'] # TODO anymal : a2c_continuous
        self.exp_config = None

        if self.seed: # TODO default : 42
            ...
            if 'env_config' in params['config']: # TODO default False(anymal)
    ...
    def run_train(self, args):
        ...
        agent = self.algo_factory.create(self.algo_name, base_name='run', params=self.params) # TODO a2c_continuous
        # TODO base_name='run', params=self.params are in **kwargs
        _restore(agent, args)
    ...
    def run_play(self, args):
        ...
        player = self.create_player() # TODO PpoPlayerContinuous
